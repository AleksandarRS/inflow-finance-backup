...
function inflow_register_cs_post_type() {
    $singular = 'Case study'; // Book
	$plural = 'Case studies';  // Books
...
add_action( 'init', 'inflow_register_cs_post_type' );

function inflow_register_cs_custom_taxonomy() {
    $singular = 'Case study category'; // Book category
	$plural = 'Case study categories'; // Book categories
    ...
    register_taxonomy( $slug, 'case-studies', $args );
}
add_action( 'init', 'inflow_register_cs_custom_taxonomy', 0 );