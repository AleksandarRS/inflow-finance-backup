                                    ...
                                    <div class="facility-overview-table facility-overview-table-second wow fadeIn" data-wow-delay="0.2s" data-wow-duration="1s">
                                        <?php while ( have_rows('second_box_details_list_s') ) : the_row(); ?>
                                            <div class="facility-overview-table-item">
                                                ...
                                                <div class="facility-overview-table-cell wow fadeInRight" data-wow-delay="0.4s" data-wow-duration="1s"><?php the_sub_field('details_item_second_column_s'); ?><span class="cell-note"><?php the_sub_field('details_item_note'); ?></span></div>
