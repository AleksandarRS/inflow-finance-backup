                                    ...
                                    <div class="facility-overview-table facility-overview-table-first">
                                        <?php while ( have_rows('first_box_details_list_c') ) : the_row(); ?>
                                            <div class="facility-overview-table-item">
                                                <div class="facility-overview-table-cell"><?php the_sub_field('details_item_first_column_c'); ?></div>
                                                <div class="facility-overview-table-cell"><?php the_sub_field('details_item_second_column_c'); ?></div>
                                            </div>
                                        <?php endwhile; ?>
                                    </div>
                                </div>
                                ...
                                <div class="facility-overview-table-wrap facility-overview-second-table-wrap">
                                    <div class="facility-overview-table facility-overview-table-second">
                                        <?php while ( have_rows('second_box_details_list_s_c') ) : the_row(); ?>
                                            <div class="facility-overview-table-item">
                                                <div class="facility-overview-table-cell"><?php the_sub_field('details_item_first_column_s_c'); ?></div>
                                                <div class="facility-overview-table-cell"><?php the_sub_field('details_item_second_column_s_c'); ?><span class="cell-note"><?php the_sub_field('details_item_note'); ?></span></div>
