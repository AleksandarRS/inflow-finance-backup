...
<section class="hero-section hero-section-single-product hero-posts">
    <div class="hero-section-wrapper relative"<?php if ( $add_hero_background_color ) : ?> style="background-color:<?php echo $add_hero_background_color; ?>"<?php endif; ?>>
        <?php  if ( $hero_background_image ) : ?>
            <div class="hero-section-background-image" style="background-image: url(<?php echo esc_url($hero_background_image['url']); ?>);" role="img" aria-label="<?php echo esc_attr($hero_background_image['alt']); ?>"></div>
        <?php endif; ?>
        <div class="container">
